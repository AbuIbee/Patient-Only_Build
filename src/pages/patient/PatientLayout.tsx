...
import {
  LayoutDashboard, Calendar, Pill, FileText, Bell, ClipboardCheck,
...
type PatientView = 'dashboard' | 'medications' | 'routines' | 'memories' | 'mood' | 'documents' | 'reminders' | 'checkin' | 'careteam' | 'media' | 'games' | 'intake';
...
export default function PatientLayout() {
  ...
  const navItems = [
    ...
    { id: 'intake'    as PatientView, label: 'My Profile',   icon: ClipboardCheck },
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'intake':      return <PatientIntakeForm onCompleted={() => setIntakeCompleted(true)} />;
